...
<HTML>
	...
	<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="5%">
							...
							<c:if test="${o.state==2}">
							<!-- /store_v5/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}或 ${pageContext.request.contextPath}/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}-->
			...
			<td align="center" style="HEIGHT: 22px" width="60%">
				<input type="button" value="订单详情" id="${o.oid}" class="myClass"/>
						...
						<tr align="center">
							<td><img alt="" src="/store_v5/products/1/c_0001.jpg" width="50px"></td>
							<td>xx</td>
							<td>xx</td>
							<td>xx</td>
						</tr> -->
			...
			if(txt=="订单详情"){
				...
				$.post(url,obj,function(data){
					...
					$.each(data,function(i,obj){
						var td="<tr align='center'><td><img src='/store_v5/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
						$tb.append(td);				
					})
				},"json");
