...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<%--分页显示的开始 --%>
    	<div style="text-align:center">
    		...
    		<!--  url 地址拼接 ${pageContext.request.contextPath} = store_v5    ${page.url} = ProductServlet?method=findByCidWithPage&cid=1 -->
    		<!-- <a href="/store_v5/ProductServlet?method=findByCidWithPage&cid=1&num=1">首页</a> -->
