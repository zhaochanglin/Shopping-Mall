...
//		props.setProperty("mail.smtp.auth", "true");// 指定验证为true
		...
		Authenticator auth = new Authenticator() {
			public PasswordAuthentication getPasswordAuthentication() {
				//设置发送人的帐号和密码
				return new PasswordAuthentication("admin@store.com", "1");
			}
		};
		...
		String url="http://localhost:80/store_v5/UserServlet?method=active&code="+emailMsg;
		...
		System.out.println("激活码："+ emailMsg);
	}
